...
```sh
gowheels pypi --package-name gotmplfumpt --name gotmplfumpt --repo StevenACoffman/gotmplfumpt
```
...
gowheels pypi --name gotmplfumpt --package-name gotmplfumpt --repo StevenACoffman/gotmplfumpt --upload
```
...
```sh
gowheels pypi --name gotmplfumpt --package-name gotmplfumpt --repo StevenACoffman/gotmplfumpt --version v0.1.0 --upload
```
